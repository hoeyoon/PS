## **💻 문제 설명**
[문제링크](https://jungol.co.kr/problem/2857?cursor=Niw0LDI=)
...
![](https://u.jungol.co.kr/problem/2857/680e8db0-d151-4ebe-9521-4ec3756ef01d.png)
...
```
## **💡 접근 및 설계**
문자열의 최대길이만큼 반복문을 돌리고 i < str[j].size() 일때만 출력한다.
